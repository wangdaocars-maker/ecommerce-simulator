...
export default function ProductDetailClient({ productId }: ProductDetailClientProps) {
  ...
  const [latestShipTime, setLatestShipTime] = useState<Dayjs | null>(null) // 预售最晚发货时间
                        ...
                        {saleType === 'presale' && (
                          <div style={{ marginTop: 16 }}>
                            ...
                            <DatePicker
                              ...
                              onChange={(value: Dayjs | null) => setLatestShipTime(value)}
                              style={{ width: 280 }}
                              ...
                              renderExtraFooter={() => (
                                <div style={{ textAlign: 'right', padding: '8px 0' }}>
                                  <Button type="link" size="small">选择时间</Button>
                                </div>
                              )}
                            />
                          </div>
